            ...
            <Box>
              ...
              <Box mt={4}>
                ...
                <Text>
                  ...
                  Délégué Général Monsieur Bruno LUCAS, procède à un traitement de données à caractère personnel
                  concernant le représentant de l'employeur, son apprenti , le cas échéant le représentant légal de
                  l'apprenti, le maître d'apprentissage, le représentant du Centre de Formation des Apprentis pour les
                  finalités suivantes :
                  <br />
                  <br />
                </Text>
              ...
              <Box mt={4}>
                ...
                <Text>
                  Ce traitement est nécessaire au respect d&#39;obligations légales auxquelles le responsable du
                  traitement est soumis ((article 6.1.c) du Règlement général sur la protection des données (RGPD) du 27
                  avril 2016 et de la Loi n°78-17 du 6 janvier 1978 dite Loi Informatique et Libertés).
                  <br />
                  <br />
                </Text>
                <Text>
                  La transmission dématérialisée du contrat d&#39;apprentissage au Ministère du Travail et le traitement
                  des données sont des obligations légales fondées sur :
                </Text>
                <UnorderedList ml="30px !important">
                  ...
                  <ListItem>
                    ...
                    automatisés de données à caractère personnel relatives au service dématérialisé de l&#39;alternance
              ...
              <Box mt={4}>
                ...
                <Text>
                  ...
                  dématérialisé de l&#39;alternance mis à disposition des usagers, est de 10 ans suivant la date de fin
                  du contrat.
                </Text>
              </Box>
              <Box mt={4}>
                ...
                <OrderedList ml="30px !important">
                  ...
                  <ListItem>
                    2° Les personnes et agents habilités par les Directions Régionales de l'Economie, de l'Emploi, du
                    Travail et des Solidarités, la Direction Régionale et Interdépartementale de l'Economie, de
                    l'Emploi, du Travail et des Solidarités, les Directions Départementales de l'Emploi, du Travail et
                    des Solidarités, la Direction Générale de la COhésion et des POPulations de Guyane, les Directions
                    de l'Economie, de l'Emploi, du Travail et des Solidarités, Unités départementales ;
                  </ListItem>
                  <ListItem>
                  ...
                  <ListItem>
                    4° les personnes habilitées par le Centre de Formation d&#39;Apprentis et uniquement sur le service
                    par voie dématérialisée de dépôts des contrats et des documents ;
                  </ListItem>
                </OrderedList>
              </Box>
              <Box mt={4}>
                ...
                <Text>
                  ...
                  industriel et commercial ». Les destinataires ultérieurs et finalités ultérieures sont indiqués dans
                  les mentions d'information du même nom.
                </Text>
              </Box>
              <Box mt={4}>
                <Heading as={"h3"} textStyle="h6" mb={2}>
              ...
              <Box mt={4}>
                ...
                <Text>
                  ...
                  de l&#39;Etat dans le département du lieu d&#39;exécution du contrat dont il dépend : DR(I)EETS,
                  DDETS, DEETS, DGCOPOP.
                  <br />
                  <br />
                </Text>
                <UnorderedList ml="30px !important">
                  <ListItem>
                    le représentant de l'état vérifie que le contrat vérifie qu'il satisfait aux conditions posées aux
                    articles L. 6211- 1 relatif aux formations éligibles à l&#39;apprentissage, L. 6222-1 à L. 6222-3
                    relatifs à l&#39;âge de l&#39;apprenti, D. 6222-26 à D. 6222-33 relatifs à la rémunération des
                    apprentis et dépose définitivement le contrat dans service dématérialisé de l'apprentissage des
                    employeurs publics
                  </ListItem>
                </UnorderedList>
              </Box>
              <Box mt={4}>
                ...
                <Text>
                  Conformément au RGPD et à la loi n° 78-du 6 janvier 1978 relative à l&#39;informatique, aux fichiers
                  et aux libertés (loi informatique et libertés) et dans les conditions prévues par ces mêmes textes,
                  vous disposez d'un droit d'accès et de rectification. Vous pouvez également demander la limitation du
                  traitement de vos données.
                </Text>
                <Box mt={4}>
                  <Text>
                    Vous pouvez exercer ces droits, en vous adressant auprès de votre responsable de traitement auprès
                    de :
                  </Text>
                  ...
                  <Text>
                    Si vous estimez, après avoir contacté la DGEFP, que vos droits ne sont pas respectés ou que le
                    traitement n'est pas conforme au Règlement Général sur la Protection des données Personnelles, vous
                    pouvez adresser une réclamation auprès de la Commission Nationale Informatique et Liberté (CNIL).
                  </Text>
                </Box>
              </Box>
            </Box>
