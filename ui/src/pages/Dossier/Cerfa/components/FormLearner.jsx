      ...
      <Flex>
        <Box w="55%" flex="1">
          ...
          <FormControl mt={2} isInvalid={errors.nameLegal}>
            ...
            <Input type="text" name="nameLegal" onChange={handleChange} value={values.nameLegal} />
          ...
          <FormControl mt={2} isInvalid={errors.zipCodeLegal}>
            ...
            {errors.zipCodeLegal && touched.zipCodeLegal && <FormErrorMessage>{errors.zipCodeLegal}</FormErrorMessage>}
          </FormControl>
        ...
        <Box w="45%" ml="5w">
          ...
          <FormControl isRequired mt={2} isInvalid={errors.townShipOfBirth}>
            ...
            <Input type="text" name="townShipOfBirth" onChange={handleChange} value={values.townShipOfBirth} required />
          ...
          <FormControl isRequired mt={2} isInvalid={errors.socialRegime}>
            ...
            {errors.socialRegime && touched.socialRegime && <FormErrorMessage>{errors.socialRegime}</FormErrorMessage>}
          </FormControl>
