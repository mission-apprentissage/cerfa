export const idccControl = [
    ...
    process: ({ values, fields }) => {
      ...
      return {
        cascade: {
          ...
          "employeur.libelleIdcc": { value: fields["employeur.libelleIdcc"].value.trim() }, // fields["employeur.libelleIdcc"].enum[index].trim()
        },
      };
    },
  },
  {
    ...
    process: ({ values, fields }) => {
      ...
      const libelleIdcc = fields["employeur.libelleIdcc"].value; // fields["employeur.libelleIdcc"].enum[index];
