...
import { workspacePathsAtom, workspaceTitlesAtom, workspaceAtom } from "../../hooks/workspaceAtoms";
...
export const Header = ({ isSharedWorkspace }) => {
  ...
  const isParametresUtilisateursPages = router.pathname.includes(`${paths.base}/parametres/utilisateurs`);
    ...
    <Flex as="nav" align="center" justify="space-between" wrap="wrap" w="100%">
      ...
      {hasContextAccessTo(workspace, "wks/page_espace/page_dossiers/ajouter_nouveau_dossier") && (
        <Button
          ...
          h={{ base: 8, md: 10 }}
          onClick={() => {
            router.push(paths.nouveauDossier);
          }}
          variant="primary"
        >
