...
const MaskedInput = ({ value, precision, min, onChange, mask, maskblocks, unmask, ...props }) => {
        ...
        <HStack>
          <InputGroup id={`${name}_group_input`}>
            ...
            {(shouldBeDisabled || isLoading || validated || isErrored) && type !== "radio" && (
              <InputRightElement position={!hasInfo ? "inherit" : "absolute"}>
                <Center
                  bg="grey.200"
                  w="40px"
                  h="40px"
