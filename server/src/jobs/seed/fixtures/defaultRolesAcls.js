module.exports = {
  "wks.admin": {
    ...
    acl: [
      ...
      "wks/page_espace/page_dossiers/modifier_dossier_demande_complement",
  ...
  "dossier.admin": {
    ...
    acl: [
      ...
      "dossier/page_signatures/signature_papier",
      "dossier/page_signatures/signature_electronique",
      "dossier/page_statut",
      "dossier/page_suivi",
      "dossier/page_suivi/modifier_demande_complements",
      "dossier/publication",
      "dossier/envoyer",
