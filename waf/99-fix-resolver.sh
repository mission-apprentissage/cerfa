...
sed -i.bak "s/ssl_dhparam \/etc\/ssl\/certs\/dhparam-2048.pem;/ssl_dhparam \/ssl\/ssl-dhparams.pem;\ninclude \/ssl\/options-ssl-nginx.conf;/g" /etc/nginx/conf.d/default.conf
